...
print(c8)
print(c7,"\n")
print(int((c1.vefat-c1.vefat.mean()).pow(2).sum()))
print(int((c3.vefat-c3.vefat.mean()).pow(2).sum()))
print(int((c5.vefat-c5.vefat.mean()).pow(2).sum()))
print(int((c7.vefat-c7.vefat.mean()).pow(2).sum()))
print(int((c8.vefat-c8.vefat.mean()).pow(2).sum()))
